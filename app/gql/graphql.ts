...
export type AppMyDependentsQueryVariables = Exact<{ [key: string]: never; }>;


export type AppMyDependentsQuery = { __typename?: 'Query', me?: { __typename?: 'Student', documentId: string, name: string, academy?: { __typename?: 'Academy', documentId: string, name: string } | null } | null, myDependents?: Array<{ __typename?: 'Dependent', documentId: string, name: string, birthdate: string, gender?: string | null, status: string, medicalAlert?: string | null, bloodType?: string | null, emergencyContactName?: string | null, emergencyContactPhone?: string | null, enrollments?: Array<{ __typename?: 'Enrollment', documentId: string, startDate: string, endDate?: string | null, plan?: { __typename?: 'Plan', documentId: string, name: string, price: number } | null } | null> | null } | null> | null };

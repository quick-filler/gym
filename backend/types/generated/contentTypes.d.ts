...
export interface ApiAcademyAcademy extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Tenant root entity. Each academy has its own branding and data isolation.';
    displayName: 'Academy';
...
export interface ApiBodyAssessmentBodyAssessment
  ...
  info: {
    description: 'Physical evaluation (avalia\u00E7\u00E3o f\u00EDsica) snapshot.';
    displayName: 'Body Assessment';
    pluralName: 'body-assessments';
    singularName: 'body-assessment';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    bodyFat: Schema.Attribute.Decimal;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiClassBookingClassBooking
  extends Struct.CollectionTypeSchema {
  collectionName: 'class_bookings';
  info: {
    description: "A student's booking for a specific class on a specific date.";
  ...
  attributes: {
    ...
    classSchedule: Schema.Attribute.Relation<
      'manyToOne',
      'api::class-schedule.class-schedule'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiClassScheduleClassSchedule
  extends Struct.CollectionTypeSchema {
  collectionName: 'class_schedules';
  info: {
    description: 'A recurring class slot in the academy schedule (grade de aulas).';
    displayName: 'Class Schedule';
    pluralName: 'class-schedules';
    singularName: 'class-schedule';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    maxCapacity: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<20>;
    modality: Schema.Attribute.Enumeration<['presential', 'online']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'presential'>;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiEnrollmentEnrollment extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Links a student to a membership plan (matr\u00EDcula).';
  ...
  attributes: {
    asaasCustomerId: Schema.Attribute.String & Schema.Attribute.Private;
    asaasSubId: Schema.Attribute.String & Schema.Attribute.Private;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dependent: Schema.Attribute.Relation<
    ...
    > &
      Schema.Attribute.DefaultTo<'pix'>;
...
export interface ApiLeadLead extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Contact form submission / trial request from the marketing site.';
    displayName: 'Lead';
    pluralName: 'leads';
    singularName: 'lead';
  };
  ...
  attributes: {
    academyName: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPaymentPayment extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'An individual payment instalment for an enrollment.';
    displayName: 'Payment';
    pluralName: 'payments';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    method: Schema.Attribute.Enumeration<['pix', 'credit_card', 'boleto']> &
      Schema.Attribute.DefaultTo<'pix'>;
    paidAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPlanPlan extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Membership plan (plano de matr\u00EDcula) that students subscribe to.';
    displayName: 'Plan';
    pluralName: 'plans';
    singularName: 'plan';
  };
...
export interface ApiStudentStudent extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Academy member (aluno).';
    displayName: 'Student';
    pluralName: 'students';
  ...
  attributes: {
    ...
    name: Schema.Attribute.String & Schema.Attribute.Required;
    notes: Schema.Attribute.Text;
    notificationPrefs: Schema.Attribute.JSON;
    phone: Schema.Attribute.String;
    photo: Schema.Attribute.Media<'images'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiWorkoutPlanWorkoutPlan extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Personalised workout (ficha de treino) for a student.';

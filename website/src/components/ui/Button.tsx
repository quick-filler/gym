...
type Variant = "ghost" | "ink" | "primary" | "flame" | "line";
...
const variants: Record<Variant, string> = {
  ...
  // primary — academy-tinted CTA at ink's compact size. Use this for the
  // "+ create X" headers across /admin so each tenant's brand color shows
  // up on the action that matters most. flame is the brand-facing
  // marketing variant (heavier shadow, larger typography).
  primary:
    "bg-flame text-white hover:bg-flame-dark active:translate-y-[1px] px-[1.3rem] py-3 text-[0.92rem]",
  flame:
